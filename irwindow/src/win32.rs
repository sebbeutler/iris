...
pub unsafe fn on_lbuttondown(hwnd: HWND) {
...
pub fn create_main_window(name: &str, title: &str) -> Result<HWND, Box<dyn Error>> {
...
pub fn run_message_loop(hwnd: HWND) -> WPARAM {
    unsafe {
